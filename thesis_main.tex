...
\documentclass[11pt, a4paper,DIV=13, BCOR=20mm, english, ngerman]{scrbook}
...
\begin{document}
    ...
    %\include{chapters/0_3-deutscheZusammenfassung}
    \tableofcontents
    \listoffigures
    \listoftables
    %\listofalgorithms
    ...
    \include{chapters/3-materialsAndMethods}
    %\include{chapters/4-simulations}
    \include{chapters/5-results}
    \include{chapters/6-conclusions}
    \include{chapters/7-acknowledgments}
    \include{chapters/7_1-publications}
    ...
    \bibliography{bib/general.bib,bib/nucleiSpins,bib/parahydrogen.bib,bib/HP.bib,bib/MRI.bib,bib/NMR.bib,bib/hardware.bib}
